                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="gallerygambar[]" id="image"
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="judulgallery"
                                                class="form-control <?= ($validation->hasError('judulgallery')) ? 'is-invalid' : ''; ?>"
                                                id="formGroupExampleInput" placeholder="Judul"
                                                value="<?= (old('judulgallery')); ?>" autofocus>
                                            <div id="validationServer03Feedback" class="invalid-feedback">
